function [u_spec,z16,z32,zinter] = specquad_lapl(u, mudens, Npanels, panels, zDrops, ...
    zpDrops, wDrops, z, tau, IP1, IP2, W16, W32,u_known)


u_spec = u;
testaavst = 0; ok32 = 0; test_p32 = zeros(size(z));
